...
def raw2outputs(raw, z_vals, dists, white_bkgd=False, net_type='v2'):
    ...
    return rgb_map, disp_map, acc_map, weights, depth_map, uncert_map, alpha
...
def rendering(args, pose_ref, rays_pts, rays_ndc, depth_candidates, rays_o, rays_dir,
    ...
    rgb_map, disp_map, acc_map, weights, depth_map, uncert_map, alpha = raw2outputs(raw, depth_candidates, dists, white_bkgd,args.net_type)
    ret = {'raw':raw, 'uncert':uncert_map}
    # ret = {}
