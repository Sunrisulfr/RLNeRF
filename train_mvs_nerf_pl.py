...
class MVSSystem(LightningModule):
    def __init__(self, args):
        ...
        self.args.feat_dim = 8+self.n_views*4 #3 images n_views
        self.idx = 0
    ...
    def prepare_data(self):
        ...
        self.val_dataset   = dataset(root_dir=val_dir, split='val',  n_views = args.n_views, max_len=10 , downSample=args.imgScale_test)#
    ...
    def training_step(self, batch, batch_nb):
        ...
        volume_feature, img_feat, depth_values = self.MVSNet(imgs[:, :self.n_views], proj_mats[:, :self.n_views], near_fars[0,0],pad=args.pad) #n_views
    ...
    def validation_step(self, batch, batch_nb):
        ...
        with torch.no_grad():
            ...
            volume_feature, img_feat, _ = self.MVSNet(imgs[:, :self.n_views], proj_mats[:, :self.n_views], near_fars[0], pad=args.pad) #n_views
            imgs = self.unpreprocess(imgs)
            rgbs, depth_preds = [],[]
